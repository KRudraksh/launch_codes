...
if __name__ == '__main__':
	...
	if (True):		
		...
		wps = []
		w_1 = wayp_11.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_11[0], wp_g_11[1], wp_g_11[2])
		# appending twice to avoid the skipping of first waypoint
		w_2 = wayp_12.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_12[0], wp_g_12[1], wp_g_12[2])
		w_3 = wayp_13.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_13[0], wp_g_13[1], wp_g_13[2])
		w_4 = wayp_21.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		w_5 = wayp_22.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_22[0], wp_g_22[1], wp_g_22[2])
		w_6 = wayp_23.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		w_land = wayp_land.setWaypoints(3,21,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
