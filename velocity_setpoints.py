...
class FLIGHT_CONTROLLER:
	...
	def __init__(self):
		...
		self.publish_attitude_thrust=rospy.Publisher('/mavros/setpoint_raw/attitude', AttitudeTarget,queue_size=10)
	...
	def getvelBody(self, u, v, w,t):
		...
		delta_t = current_time - starting_time
		while delta_t <= t:
...
if __name__ == '__main__':
	...
	if (mav.within_rad()):
		...
		time.sleep(10)
		mav.getvelBody(2,0,0,5)
		time.sleep(5)
		mav.getvelBody(0,2,0,5)
		mav.toggle_arm(0)
